...
import {
  UpdateStakingModuleShareLimits as UpdateStakingModuleShareLimitsContract,
  CSM2UpdateStakingModuleShareLimits as CSM2UpdateStakingModuleShareLimitsContract,
...
const UPDATE_STAKING_MODULE_SHARE_LIMITS_MAP = {
  ...
  [MotionType.CSM2UpdateStakingModuleShareLimits]:
    CSM2UpdateStakingModuleShareLimitsContract,
} as const;

export const formParts = ({
  motionType,
}: {
  motionType: keyof typeof UPDATE_STAKING_MODULE_SHARE_LIMITS_MAP;
}) =>
  createMotionFormPart({
    motionType,
    populateTx: async ({
    ...
    Component: ({ fieldNames, submitAction }) => {
      ...
      const factory = UPDATE_STAKING_MODULE_SHARE_LIMITS_MAP[motionType];
      ...
      const validateNewPriorityExitShareThreshold = (value: string) => {
        ...
        return validateRelations(
          getValues(fieldNames.newStakeShareLimit),
          value,
        );
      };
