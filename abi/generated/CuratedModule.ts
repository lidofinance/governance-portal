...
export const curatedModuleAbi = [
  {
    ...
    inputs: [
      ...
      { name: 'metaRegistry', internalType: 'address', type: 'address' },
    ],
  ...
  { type: 'error', inputs: [], name: 'SenderIsNotMetaRegistry' },
  ...
  { type: 'error', inputs: [], name: 'ZeroMetaRegistryAddress' },
  ...
  },
  {
    ...
    inputs: [
      { name: 'nodeOperatorId', internalType: 'uint256', type: 'uint256' },
      { name: 'newManagerAddress', internalType: 'address', type: 'address' },
      { name: 'newRewardAddress', internalType: 'address', type: 'address' },
    ],
  ...
  },
  {
    ...
    inputs: [
      { name: 'nodeOperatorId', internalType: 'uint256', type: 'uint256' },
      { name: 'proofSlotTimestamp', internalType: 'uint256', type: 'uint256' },
  ...
  },
  {
    ...
    inputs: [
      { name: 'nodeOperatorId', internalType: 'uint256', type: 'uint256' },
      { name: 'oldWeight', internalType: 'uint256', type: 'uint256' },
  ...
  },
  {
    ...
    inputs: [
      { name: 'nodeOperatorIds', internalType: 'uint256[]', type: 'uint256[]' },
      { name: 'bondLockNonces', internalType: 'uint256[]', type: 'uint256[]' },
    ],
