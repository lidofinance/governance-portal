...
export const stethAbi = [
  ...
  },
  {
    ...
    payable: false,
    type: 'function',
    inputs: [{ name: '_depositsReserveTarget', type: 'uint256' }],
  ...
  },
  {
    ...
    inputs: [
      { name: 'reportTimestamp', type: 'uint256', indexed: true },
      { name: 'clValidatorsBalance', type: 'uint256', indexed: false },
      { name: 'clPendingBalance', type: 'uint256', indexed: false },
    ],
  ...
  },
  {
    type: 'event',
    anonymous: false,
    inputs: [{ name: 'depositedPostReport', type: 'uint256', indexed: false }],
    name: 'DepositedPostReportUpdated',
  },
  {
    type: 'event',
    anonymous: false,
    inputs: [{ name: 'depositsReserve', type: 'uint256', indexed: false }],
  ...
  },
  {
    ...
    anonymous: false,
    inputs: [
      { name: 'depositsReserveTarget', type: 'uint256', indexed: false },
    ],
