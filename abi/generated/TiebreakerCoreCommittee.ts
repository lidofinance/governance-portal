...
export const tiebreakerCoreCommitteeAbi = [
  {
    type: 'constructor',
    inputs: [
      { name: 'owner', internalType: 'address', type: 'address' },
      { name: 'dualGovernance', internalType: 'address', type: 'address' },
      { name: 'timelock', internalType: 'Duration', type: 'uint32' },
    ],
  ...
  { type: 'error', inputs: [], name: 'ResumeSealableNonceMismatch' },
  {
    type: 'error',
    inputs: [{ name: 'sealable', internalType: 'address', type: 'address' }],
  ...
  },
  {
    type: 'function',
    inputs: [
      { name: 'sealable', internalType: 'address', type: 'address' },
