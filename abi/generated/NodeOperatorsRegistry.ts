...
export const nodeOperatorsRegistryAbi = [
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: '_stuckPenaltyDelay', type: 'uint256' },
    ],
    name: 'initialize',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  },
  {
    ...
    inputs: [
      { name: '_nodeOperatorIds', type: 'bytes' },
      { name: '_stuckValidatorsCounts', type: 'bytes' },
    ],
  ...
  },
  {
    ...
    inputs: [
      { name: '_nodeOperatorId', type: 'uint256' },
      { name: '_refundedValidatorsCount', type: 'uint256' },
    ],
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: '_stuckValidatorsCount', type: 'uint256' },
    ],
  ...
  },
  {
    type: 'event',
    anonymous: false,
    inputs: [{ name: 'stuckPenaltyDelay', type: 'uint256', indexed: false }],
  ...
  },
  {
    ...
    inputs: [
      { name: 'nodeOperatorId', type: 'uint256', indexed: true },
      { name: 'stuckValidatorsCount', type: 'uint256', indexed: false },
      { name: 'refundedValidatorsCount', type: 'uint256', indexed: false },
      { name: 'stuckPenaltyEndTimestamp', type: 'uint256', indexed: false },
    ],
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'sharesPenalizedAmount', type: 'uint256', indexed: false },
    ],
