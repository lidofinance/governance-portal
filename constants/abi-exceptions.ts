...
export const ABI_EXCEPTIONS = {
  ...
  HashConsensusCuratedModule: abis.hashConsensusAbi,
  ...
  Voting: abis.aragonVotingAbi,
  DAI: abis.erc20Abi,
  USDC: abis.erc20Abi,
  USDT: abis.erc20Abi,
  DaoToken: abis.miniMeTokenAbi,
  SandboxNodeOperatorsRegistry: abis.nodeOperatorsRegistryAbi,
  SimpleDVTRepo: abis.repoAbi,
  DualGovernanceResealManager: abis.resealManagerAbi,
  DualGovernanceEscrow: abis.dgEscrowAbi,
} as const;
